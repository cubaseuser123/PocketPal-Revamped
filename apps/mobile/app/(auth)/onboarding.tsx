...
const FEATURES = [
  {
    ...
    text: "Control your allowance, not your entire bank balance",
  },
  {
    icon: "local-fire-department",
    text: "Weekly saving streaks & challenges",
  },
  {
    icon: "emoji-events",
    text: "Earn coins, rewards & campus perks",
  },
  {
    icon: "lock-open",
    text: "Your money stays yours — withdraw anytime",
  },
];
      ...
      <View style={[styles.content, { paddingTop: insets.top + 32 }]}>
        ...
        <View style={styles.featuresContainer}>
          ...
          <Text style={styles.tipText}>
            PocketPal works best when you use it for a small part of your money.
          </Text>
        </View>
      </View>
