    ...
    <View style={styles.container}>
      ...
      >
        {activeGroups.map((group: any) => {
          ...
          const memberCount = group.members?.length || 1;
          const myShare = Math.round(group.totalAmount / memberCount);
              ...
              >
                <View style={styles.iconRow}>
                  <View
                    style={[
                      styles.iconBox,
                      status === "paid" || group.myStatus === "paid"
                        ? styles.iconPaid
                        : styles.iconUnpaid,
                    ]}
                  >
                  ...
                  {group.myStatus === "collecting" && (
                    ...
                    >
                      <Text style={[styles.badgeText, { color: "#448AFF" }]}>
                        Collecting
                      </Text>
                    </View>
                  )}
                  ...
                  {group.myStatus === "paid" && (
                    ...
                    >
                      <Text style={[styles.badgeText, { color: "#3DDC97" }]}>
                        Paid
                      </Text>
                    </View>
                  )}
                ...
                <Text style={styles.amount}>
                  ₹{myShare} <Text style={styles.subText}>/ share</Text>
                </Text>

                <View style={styles.membersRow}>
                  <MaterialIcons name="group" size={14} color="#757575" />
                  <Text style={styles.membersText}>
                    You + {(group.members?.length || 1) - 1}
                  </Text>
                </View>
              </LinearGradient>
            </TouchableOpacity>
