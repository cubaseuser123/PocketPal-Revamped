...
export async function getWalletContext(userId) {
    ...
    return {
        ...
        totalBalance: (primary ? parseFloat(primary.balance) : 0) + (savings ? parseFloat(savings.balance) : 0),
    ...
    return {
        ...
        featuredGoal: featured
            ? {
                ...
                remaining:
                    parseFloat(featured.targetAmount) - parseFloat(featured.currentAmount),
            }
            : null,
